          ...
          <div className="flex justify-start">
            <div className="rounded-lg bg-indigo-50 px-4 py-2.5">
              <span className="inline-flex gap-1">
                ...
                <span className="h-2 w-2 animate-bounce rounded-full bg-indigo-400" style={{ animationDelay: '200ms' }} />
                <span className="h-2 w-2 animate-bounce rounded-full bg-indigo-400" style={{ animationDelay: '400ms' }} />
              </span>
            </div>
          </div>
        )}
      ...
      <div className="border-t border-gray-200 p-4">
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="rounded-lg bg-indigo-600 p-2.5 text-white hover:bg-indigo-700 disabled:opacity-50"
          >
